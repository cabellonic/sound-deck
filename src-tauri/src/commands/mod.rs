...
macro_rules! command_handlers {
    () => {
        tauri::generate_handler![
            ...
            $crate::commands::window::begin_overlay_placement,
            $crate::commands::window::save_overlay_placement,
            $crate::commands::window::cancel_overlay_placement,
            $crate::commands::window::clear_overlay_placement,
            ...
            $crate::commands::library::restore_database,
            $crate::commands::library::measure_library_loudness,
            ...
            $crate::commands::providers::set_provider_client_id,
            $crate::commands::providers::begin_provider_authorization,
            $crate::commands::providers::complete_provider_authorization,
            $crate::commands::providers::disconnect_provider_account,
